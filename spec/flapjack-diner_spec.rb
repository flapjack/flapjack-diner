  ...
  context 'pagerduty credentials' do
    ...
    context 'read' do
     it "submits a GET request for all pagerduty credentials" do
        req = stub_request(:get, "http://#{server}/pagerduty_credentials").to_return(
          :body => response)
      ...
      it "submits a GET request for one set of pagerduty credentials" do
        req = stub_request(:get, "http://#{server}/pagerduty_credentials/72").to_return(
          :body => response)
      ...
      it "submits a GET request for several sets of pagerduty credentials" do
        req = stub_request(:get, "http://#{server}/pagerduty_credentials/72,150").to_return(
          :body => response)
